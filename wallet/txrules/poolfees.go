...
func StakePoolTicketFee(stakeDiff cdrutil.Amount, relayFee cdrutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) cdrutil.Amount {
	...
	return cdrutil.Amount(num.Int64())
}
