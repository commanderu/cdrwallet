...
import (
	...
	"github.com/commanderu/cdrwallet/snacl"
...
func normalizeAddress(addr cdrutil.Address) cdrutil.Address {
...
// now created using the coin types assigned to commanderu in SLIP0044:
//
...
// to the coin type registered to commanderu as per SLIP0044.  On mainnet, this
...
//
// This function MUST be called with the manager lock held for writes.
func (m *Manager) loadAddress(ns walletdb.ReadBucket, address cdrutil.Address) (ManagedAddress, error) {
...
func (m *Manager) Address(ns walletdb.ReadBucket, address cdrutil.Address) (ManagedAddress, error) {
...
func (m *Manager) AddrAccount(ns walletdb.ReadBucket, address cdrutil.Address) (uint32, error) {
	address = normalizeAddress(address)
...
func (m *Manager) ImportPrivateKey(ns walletdb.ReadWriteBucket, wif *cdrutil.WIF) (ManagedPubKeyAddress, error) {
	...
	pubKeyHash := cdrutil.Hash160(serializedPubKey)
...
func (m *Manager) ImportScript(ns walletdb.ReadWriteBucket, script []byte) (ManagedScriptAddress, error) {
	...
	// Prevent duplicates.
	scriptHash := cdrutil.Hash160(script)
...
func (m *Manager) MarkUsed(ns walletdb.ReadWriteBucket, address cdrutil.Address) error {
...
func (m *Manager) ForEachActiveAddress(ns walletdb.ReadBucket, fn func(addr cdrutil.Address) error) error {
	m.mtx.Lock()
	defer m.mtx.Unlock()
...
func (m *Manager) PrivateKey(ns walletdb.ReadBucket, addr cdrutil.Address) (key chainec.PrivateKey, done func(), err error) {
...
func (m *Manager) RedeemScript(ns walletdb.ReadBucket, addr cdrutil.Address) (script []byte, done func(), err error) {
