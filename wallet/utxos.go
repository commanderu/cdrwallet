...
func (w *Wallet) SelectInputs(targetAmount cdrutil.Amount, policy OutputSelectionPolicy) (total cdrutil.Amount,
...
func (w *Wallet) OutputInfo(op *wire.OutPoint) (OutputInfo, error) {
	...
	err := walletdb.View(w.db, func(dbtx walletdb.ReadTx) error {
		...
		info.Amount = cdrutil.Amount(txDetails.TxRecord.MsgTx.TxOut[op.Index].Value)
