...
// InputSourceError.
type InputSource func(target cdrutil.Amount) (total cdrutil.Amount,
...
func NewUnsignedTransaction(outputs []*wire.TxOut, relayFeePerKb cdrutil.Amount,
