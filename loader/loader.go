...
import (
	...
	_ "github.com/commanderu/cdrwallet/walletdb/bdb" // driver loaded during init
)
...
type Loader struct {
	...
	chainClient *cdrrpcclient.Client
...
func (l *Loader) SetChainClient(chainClient *cdrrpcclient.Client) {
	l.mu.Lock()
