...
func (b *rpcBackend) LoadTxFilter(ctx context.Context, reload bool, addrs []cdrutil.Address, outpoints []wire.OutPoint) error {
...
func (b *rpcBackend) AddressesUsed(ctx context.Context, addrs []cdrutil.Address) (bitset.Bytes, error) {
...
func (b *rpcBackend) StakeDifficulty(ctx context.Context) (cdrutil.Amount, error) {
	r, err := b.rpcClient.GetStakeDifficulty()
	if err != nil {
		return 0, err
	}
	return cdrutil.NewAmount(r.NextStakeDifficulty)
}
