...
var helpDescsEnUS = map[string]string{
	...
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in cdr/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in commanderu",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in commanderu",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in commanderu",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and commanderu amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in commanderu",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in commanderu",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in commanderu",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in commanderu",
	...
	"listunspentresult-amount":        "The amount of the output valued in commanderu",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in commanderu",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in commanderu to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in commanderu",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in commanderu",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in commanderu",
	...
	"setticketmaxprice-max":       "The max price (in cdr).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in commanderu",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in commanderu.",
	...
	"getwalletfee--result0":  "Current tx fee (in cdr)",
	...
	"purchaseticket-ticketfee":          "The transaction fee rate (cdr/kB) to use (overrides fees set by the wallet config or settxfee RPC)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in commanderu",
