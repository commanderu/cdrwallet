...
// processes to communicate with and and manage the lifetime of a cdr child
...
// message, shutdown begins.  This prevents cdr from continuing to run
...
// for a child cdr process to communicate with a parent process without the
