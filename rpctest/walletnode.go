...
// walletTestConfig contains all the args, and data required to launch a cdrwallet process
...
// command returns the exec.Cmd which will be used to start the cdrwallet
// process.
...
// to connect to the cdrwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for cdrwallet.
...
// Start creates a new cdrwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running cdrwalletTest process process, and waits until it exits
