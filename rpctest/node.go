...
import (
	...
	"github.com/commanderu/cdr/certgen"
	rpc "github.com/commanderu/cdr/rpcclient"
	"github.com/commanderu/cdr/wire"
)

// nodeConfig contains all the args, and data required to launch a cdr process
...
// command returns the exec.Cmd which will be used to start the cdr process.
...
// to connect to the cdr process that is launched via Start().
...
// as the base for the log and data directories for cdr.
...
// Start creates a new cdr process, and writes its pid in a file reserved for
...
// Stop interrupts the running cdr process, and waits until it exits properly.
